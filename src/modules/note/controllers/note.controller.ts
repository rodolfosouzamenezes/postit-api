...
export class NoteController {
  ...
  public getOne(
    ...
    return this.service
      .getOne(requestUser, +noteId)
      .then((entity) => new NoteProxy(entity));
  }
  ...
  public createOne(
    @User() requestUser: UserEntity,
    @Body() payload: CreateNotePayload,
  ): Promise<NoteProxy> {
    return this.service
      .createOne(requestUser, payload)
      .then((entity) => new NoteProxy(entity));
  }
  ...
  public updateOne(
    ...
    return this.service
      .updateOne(requestUser, +noteId, payload)
      .then((entity) => new NoteProxy(entity));
  }
